...
const stylizedBirckambientOcclusionMap = textureLoader.load(
  "./Stylized_Bricks_001_ambientOcclusion.jpg",
);
...
const rocksHexagonambientOcclusionMap = textureLoader.load(
...
const comicFront = new THREE.Mesh(
  new THREE.PlaneGeometry(2, 2.8284),
  new THREE.MeshStandardMaterial({ map: comicFrontBaseColor }),
);
...
const plane2 = new THREE.Mesh(
  new THREE.PlaneGeometry(2, 2),
  new THREE.MeshStandardMaterial({ map: brickWallbasecolor, normalMap: brickWallnormalMap }),
);
plane2.position.y = 3;
...
const sphere2 = new THREE.Mesh(
  new THREE.SphereGeometry(1, 512, 512),
  new THREE.MeshStandardMaterial({
    map: stylizedBirckbasecolor,
    normalMap: stylizedBircknormalMap,
    displacementMap: stylizedBirckheightMap,
    displacementScale: 0.05,
    roughnessMap: stylizedBirckroughnessMap,
    roughness: 1,
    aoMap: stylizedBirckambientOcclusionMap,
  }),
);
...
const sphere3 = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    normalMap: metalPlatenormalMap,
    displacementMap: metalPlateheightMap,
    displacementScale: 0.08,
    roughnessMap: metalPlateroughnessMap,
    roughness: 1,
    aoMap: metalPlateambientOcclusionMap,
    metalnessMap: metalPlatemetallic,
  }),
);
...
const sphere4 = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    normalMap: rocksHexagonnormalMap,
    displacementMap: rocksHexagonheightMap,
    displacementScale: 0.1,
    roughnessMap: rocksHexagonroughnessMap,
    roughness: 1,
    aoMap: rocksHexagonambientOcclusionMap,
  }),
);
